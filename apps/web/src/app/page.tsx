    ...
    <div className="flex h-screen flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <ChartPanel datasets={datasets} chartSpec={currentChart} onChartSpecEdited={handleChartSpecEdited} onFilesSelected={handleFilesSelected} themeId={themeId} onThemeChange={setThemeId} />
        </div>
      </div>
    </div>
  );
